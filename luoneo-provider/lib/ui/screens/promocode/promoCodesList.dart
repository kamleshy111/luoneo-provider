        ...
        child: BlocBuilder<FetchPromocodesCubit, FetchPromocodesState>(
          builder: (BuildContext context, FetchPromocodesState state) {
            ...
            if (state is FetchPromocodesSuccess) {
              ...
              return BlocConsumer<CreatePromocodeCubit, CreatePromocodeState>(
                listener: (context, createPromocodeState) {
                  if (createPromocodeState is CreatePromocodeFailure) {
                    UiUtils.showMessage(
                      context,
                      createPromocodeState.errorMessage,
                      ToastificationType.error,
                    );
                  }
                  if (createPromocodeState is CreatePromocodeSuccess) {
                    UiUtils.showMessage(
                      context,
                      createPromocodeState.id == null
                          ? 'createPromocodeSuccess'
                          : 'updatePromocode',
                      ToastificationType.success,
                      onMessageClosed: () {
                        if (createPromocodeState.id != null) {
                          context.read<FetchPromocodesCubit>().updatePromocode(
                            createPromocodeState.promocode,
                            createPromocodeState.id!,
                          );
                        } else {
                          context
                ...
                builder: (context, createPromocodeState) {
